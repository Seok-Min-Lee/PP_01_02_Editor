...
namespace Mediapipe.Tasks.Vision.FaceLandmarker
{
  ...
  /// </summary>
  public sealed class FaceLandmarkerOptions_Custom : Tasks.Core.ITaskOptions_Custom
  {
    ...
    /// </param>
    public delegate void ResultCallback(FaceLandmarkerResult_Custom faceLandmarksResult, Image image, long timestampMillisec);

    /// <summary>
    ///   Base options for the hand landmarker task.
    /// </summary>
    public Tasks.Core.BaseOptions_Custom baseOptions { get; }
    /// <summary>
    ...
    public FaceLandmarkerOptions_Custom(
      Tasks.Core.BaseOptions_Custom baseOptions,
    ...
    CalculatorOptions Tasks.Core.ITaskOptions_Custom.ToCalculatorOptions()
    {
