...
public class Bootstrap_Custom : MonoBehaviour
{
  [SerializeField] private AppSettings_Custom _appSettings;
  ...
  private IEnumerator Init()
  {
    ...
    {
      case AppSettings_Custom.AssetLoaderType.AssetBundle:
        {
          AssetLoader.Provide(new AssetBundleResourceManager("mediapipe"));
          break;
        }
      case AppSettings_Custom.AssetLoaderType.StreamingAssets:
        {
          AssetLoader.Provide(new StreamingAssetsResourceManager());
          break;
        }
      case AppSettings_Custom.AssetLoaderType.Local:
        {
#if UNITY_EDITOR
    ...
    ImageSourceProvider_Custom.Initialize(
      _appSettings.BuildWebCamSource_Custom(), 
      _appSettings.BuildStaticImageSource(), 
      _appSettings.BuildVideoSource()
    );
    ImageSourceProvider_Custom.Switch(_appSettings.defaultImageSource);
