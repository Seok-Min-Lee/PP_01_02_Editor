...
{
  internal class TaskInfo_Custom<T> where T : ITaskOptions_Custom
  {
    ...
    public TaskInfo_Custom(string taskGraph, List<string> inputStreams, List<string> outputStreams, T taskOptions)
    {
