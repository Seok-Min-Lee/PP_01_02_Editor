...
#pragma warning restore IDE0065
  ...
  public class PointListAnnotation_Custom : ListAnnotation_Custom<PointAnnotation_Custom>
  {
    ...
    //
    public List<Vector3> Draw_Custom(IReadOnlyList<mptcc.NormalizedLandmark> targets, bool visualizeZ = true)
    {
      ...
      if (ActivateFor(targets))
      {
        CallActionForAll(targets, (annotation, target) =>
        {
          if (annotation != null) { vertices.Add(annotation.Draw_Custom(in target, visualizeZ)); }
        });
      }
    ...
    protected override PointAnnotation_Custom InstantiateChild(bool isActive = true)
    {
