...
///       3. Attach <see cref="AnnotationController_Custom{T}" /> to AnnotationLayer.<br />
///       4. Create an empty child GameObject (let's say RootAnnotation) directly under AnnotationLayer.<br />
///       5. Attach <see cref="HierarchicalAnnotation_Custom" /> to RootAnnotation.<br />
/// </summary>
/// <remarks>
...
/// </remarks>
public abstract class AnnotationController_Custom<T> : MonoBehaviour where T : HierarchicalAnnotation_Custom
{
