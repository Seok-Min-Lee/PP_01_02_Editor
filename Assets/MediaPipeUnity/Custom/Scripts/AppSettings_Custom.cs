...
[Serializable]
public class AppSettings_Custom : ScriptableObject
{
  [Serializable]
  ...
  [Header("Custom")]
  [SerializeField] private bool _isCustomCamera;
  ...
  public WebCamSource_Custom BuildWebCamSource_Custom() => new WebCamSource_Custom(
  ...
  public StaticImageSource_Custom BuildStaticImageSource() => new StaticImageSource_Custom(
    _availableStaticImageSources,
    _defaultAvailableStaticImageResolutions
  );

  public Mediapipe.Unity.VideoSource BuildVideoSource() => new Mediapipe.Unity.VideoSource(_availableVideoSources);
}
