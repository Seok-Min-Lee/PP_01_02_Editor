...
{
  public sealed class BaseOptions_Custom
  {
    ...
    public BaseOptions_Custom(Delegate delegateCase = Delegate.CPU, string modelAssetPath = null, byte[] modelAssetBuffer = null)
    {
