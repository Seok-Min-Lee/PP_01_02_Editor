...
public class StaticImageSource_Custom : ImageSource
{
    ...
    public StaticImageSource_Custom(Texture[] availableSources, ResolutionStruct[] defaultAvailableResolutions)
    {
    ...
    //
    public override int textureWidth => image.width;
    public override int textureHeight => image.height;
    //
    ...
    public void ChangeSource(Texture texture)
    {
        image = texture;
    }
