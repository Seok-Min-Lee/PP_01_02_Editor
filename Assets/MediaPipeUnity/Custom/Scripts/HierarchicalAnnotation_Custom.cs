...
{
  public interface IHierachicalAnnotation_Custom
  {
    IHierachicalAnnotation_Custom root { get; }
    Transform transform { get; }
    RectTransform GetAnnotationLayer();
    UnityEngine.Rect GetScreenRect();
  }

  public abstract class HierarchicalAnnotation_Custom : MonoBehaviour, IHierachicalAnnotation_Custom
  {
    private IHierachicalAnnotation_Custom _root;
    public IHierachicalAnnotation_Custom root
    {
      get
      {
        if (_root == null)
        {
          ...
          _root = (parentObj != null && parentObj.TryGetComponent<IHierachicalAnnotation_Custom>(out var parent)) ? parent.root : this;
        }
        return _root;
      }
    ...
    protected TAnnotation InstantiateChild<TAnnotation>(GameObject prefab) where TAnnotation : HierarchicalAnnotation_Custom
    {
    ...
    protected TAnnotation InstantiateChild<TAnnotation>(string name = "Game Object") where TAnnotation : HierarchicalAnnotation_Custom
    {
