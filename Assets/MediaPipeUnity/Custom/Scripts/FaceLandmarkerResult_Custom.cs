...
namespace Mediapipe.Tasks.Vision.FaceLandmarker
{
  ...
  /// </summary>
  public readonly struct FaceLandmarkerResult_Custom
  {
    /// <summary>
    ...
    internal FaceLandmarkerResult_Custom(List<NormalizedLandmarks> faceLandmarks,
    ...
    public static FaceLandmarkerResult_Custom Alloc(int capacity, bool outputFaceBlendshapes = false, bool outputFaceTransformationMatrixes = false)
    {
      ...
      return new FaceLandmarkerResult_Custom(faceLandmarks, faceBlendshapes, facialTransformationMatrixes);
    }

    public void CloneTo(ref FaceLandmarkerResult_Custom destination)
    {
      ...
      destination = new FaceLandmarkerResult_Custom(dstFaceLandmarks, dstFaceBlendshapes, dstFacialTransformationMatrixes);
    }

    public override string ToString()
      => $"{{ \"faceLandmarks\": {Util_Custom.Format(faceLandmarks)}, \"faceBlendshapes\": {Util_Custom.Format(faceBlendshapes)}, \"facialTransformationMatrixes\": {Util_Custom.Format(facialTransformationMatrixes)} }}";
  }
